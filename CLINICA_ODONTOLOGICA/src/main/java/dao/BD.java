...
public class BD {
    ...
    private static final String SQL_CREATE="DROP TABLE IF EXISTS PACIENTES; " +
            ...
            "APELLIDO VARCHAR(100) NOT NULL, CEDULA VARCHAR(20) NOT NULL, FECHA_INGRESO DATE NOT NULL, DOMICILIO_ID); " +
    ...
    private static final String SQL_CREATEODONTOLOGO= "DROP TABLE IF EXISTS ODONTOLOGOS;" + "CREATE TABLE ODONTOLOGOS (ID INT AUTO_INCREMENT PRIMARY KEY, NOMBRE VARCHAR (100) NOT NULL, NOMBRE VARCHAR (100) NOT NULL)";
    ...
    private static void crearTablasOdontologo(){
        Connection connection= null;
        try{
            connection= getConnection();

            Statement statement= connection.createStatement();
            statement.execute(SQL_CREATEODONTOLOGO);
